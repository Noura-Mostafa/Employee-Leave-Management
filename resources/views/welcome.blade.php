...
<body>
        ...
        <nav class="navbar navbar-expand-md bd-light">
            <div class="container">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="navbar-brand text-secondary fs-4" href="#">Employee Managment</a>
                    </li>
                </ul>
    ...
    <main class="contanier m-auto w-75 bg-white pt-5">
        ...
        <div class="p-5 content m-auto w-75 text-center">
            ...
            <h2 class="mt-4">Welcome to Employee Managment ,<br>
                Here you can Manage Employee ..</h2>

                <div class="action d-flex m-auto justify-content-center">
                <a href="{{route('employees.index')}}" class="btn btn-primary mt-4">View Dashboard</a>
                </div>
        </div>
    </main>
